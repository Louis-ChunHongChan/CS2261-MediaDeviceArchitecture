...
void updatePlayer() {
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<6)))) {
        ...
        if (collisionCheck(collisionMap, 256, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, 0, -pikachu.rdel) && pikachu.worldRow > 0) {
            pikachu.worldRow -= pikachu.rdel;



            if (vOff-1 >= 0 && (pikachu.worldRow - vOff) <= (160 / 2)) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) {
        ...
        if (collisionCheck(collisionMap, 256, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, 0, pikachu.rdel)
                && pikachu.worldRow + pikachu.height - 1 < 256) {
            pikachu.worldRow += pikachu.rdel;



            if (vOff+1 < 256 - 160 && (pikachu.worldRow - vOff) > (160 / 2)) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
        ...
        if (collisionCheck(collisionMap, 256, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, -pikachu.cdel, 0)
                && pikachu.worldCol > 0) {
            pikachu.worldCol -= pikachu.cdel;



            if (hOff-1 >= 0 && (pikachu.worldCol - hOff) <= (240 / 2)) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        ...
        if (collisionCheck(collisionMap, 256, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, pikachu.cdel, 0)
                && pikachu.worldCol + pikachu.width - 1 < 256) {
            pikachu.worldCol += pikachu.cdel;



            if (hOff+1 < 256 - 240 && (pikachu.worldCol - hOff) > (240 / 2)) {
...
void drawPlayer() {
    ...
    if (pikachu.hide) {
        ...
        shadowOAM[0].attr0 = (pikachu.worldRow - vOff) | (0<<14);
        shadowOAM[0].attr1 = (pikachu.worldCol - hOff) | (1<<14);
