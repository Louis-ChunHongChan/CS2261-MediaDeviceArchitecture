...
void updatePlayer() {
    if(BUTTON_HELD(BUTTON_UP)) {
        ...
        // (unsigned char *collisionMap, int mapWidth, int col, int row, int width, int height, int colShift, int rowShift)
        if (collisionCheck(collisionMap, MAPWIDTH, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, 0, -pikachu.rdel) && pikachu.worldRow > 0) {
            ...
            if (vOff-1 >= 0 && (pikachu.worldRow - vOff) <= (SCREENHEIGHT / 2)) {
    ...
    if(BUTTON_HELD(BUTTON_DOWN)) {
        ...
        if (collisionCheck(collisionMap, MAPWIDTH, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, 0, pikachu.rdel)
                && pikachu.worldRow + pikachu.height - 1 < MAPHEIGHT) {
            pikachu.worldRow += pikachu.rdel;

            // TODO 1.0: Only move the screen if the character is in the proper spot
            // AND the screen isn't already at the edge
            if (vOff+1 < MAPHEIGHT - SCREENHEIGHT && (pikachu.worldRow - vOff) > (SCREENHEIGHT / 2)) {
    ...
    if(BUTTON_HELD(BUTTON_LEFT)) {
        // TODO 1.0: Replace the 1 (always true) with the correct conditional check
        if (collisionCheck(collisionMap, MAPWIDTH, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, -pikachu.cdel, 0)
                && pikachu.worldCol > 0) {
            pikachu.worldCol -= pikachu.cdel;

            // TODO 1.0: Only move the screen if the character is in the proper spot
            // AND the screen isn't already at the edge
            if (hOff-1 >= 0 && (pikachu.worldCol - hOff) <= (SCREENWIDTH / 2)) {
                // TODO 1.0: Update background offset if the above is true
                hOff--;
            }
        }
    ...
    if(BUTTON_HELD(BUTTON_RIGHT)) {
        ...
        if (collisionCheck(collisionMap, MAPWIDTH, pikachu.worldCol, pikachu.worldRow, pikachu.width, pikachu.height, pikachu.cdel, 0)
                && pikachu.worldCol + pikachu.width - 1 < MAPWIDTH) {
            pikachu.worldCol += pikachu.cdel;

            // TODO 1.0: Only move the screen if the character is in the proper spot
            // AND the screen isn't already at the edge
            if (hOff+1 < MAPWIDTH - SCREENWIDTH && (pikachu.worldCol - hOff) > (SCREENWIDTH / 2)) {
                // TODO 1.0: Update background offset if the above is true
                hOff++;
            }
        }
...
void drawPlayer() {
    ...
    if (pikachu.hide) {
        ...
        shadowOAM[0].attr0 = (pikachu.worldRow - vOff) | ATTR0_SQUARE;
        shadowOAM[0].attr1 = (pikachu.worldCol - hOff) | ATTR1_SMALL;
