...
void goToStart() {
    ...
    seed = 0;
    lost = 0;
    drawString((240 - (21 * 6)) / 2, 0, "Press SELECT To Play", 0);
}
...
void goToPause() {
    fillScreen(0);
    state = PAUSE;
    drawString((240 - (7 * 6)) / 2, 0, "PAUSED", ((31) | (31)<<5 | (31)<<10));
}
...
void goToWin() {
    ...
    drawString((240 - (32 * 6)) / 2, 0, "You Cleared All The Water Mines!", ((31) | (0)<<5 | (31)<<10));
}
...
void goToLose() {
    ...
    drawString((240 - (8 * 6)) / 2, 0, "You Died", ((31) | (0)<<5 | (0)<<10));
}
