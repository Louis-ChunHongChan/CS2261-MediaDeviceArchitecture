...
u16 pickColor[] = {((15) | (15)<<5 | (15)<<10), ((31) | (0)<<5 | (31)<<10), ((31) | (0)<<5 | (0)<<10), ((31) | (31)<<5 | (31)<<10)};
u16 largeHitColor[] = {((15) | (15)<<5 | (15)<<10), ((31) | (0)<<5 | (0)<<10), ((31) | (31)<<5 | (31)<<10)};
...
void updateClaw() {
 ...
 if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5))) && claw.col >= claw.cdel) {
  claw.col -= claw.cdel;
 }

 else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<4))) && claw.col + claw.width - 1 < 240 - claw.cdel) {
  claw.col += claw.cdel;
 }

 else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<7))) && claw.row + claw.height + claw.width/4 < 160) {
  claw.stickLength += claw.rdel;
  claw.row += claw.rdel;
 }

 else if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<6))) && claw.row > 0) {
  claw.row -= claw.rdel;
 }
}
...
void drawClaw() {
 ...
 drawClawModel(claw.oldCol, claw.oldRow, claw.width, claw.height, claw.stickLength, ((0) | (0)<<5 | (31)<<10));
...
void updateBomb(BOMB* b) {
 ...
 if (b->active) {
  ...
  if (b->col <= 0 || b->col + b->width-1 >= 240) {
   b->cdel *= -1;
   b->touched++;
   if (b->size == 's') {
...
void drawBomb(BOMB* b) {
 ...
 if (b->active) {
  if (b->size == 's') {
   drawSmallBomb(b->oldCol, b->oldRow, b->width, b->height, ((0) | (0)<<5 | (31)<<10));
   drawSmallBomb(b->col, b->row, b->width, b->height, b->color);
  }

  if (b->size == 'l') {
   drawLargeBomb(b->oldCol, b->oldRow, b->width, b->height, ((0) | (0)<<5 | (31)<<10));
