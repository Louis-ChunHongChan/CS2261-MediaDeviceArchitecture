...
void goToGame() {
    ...
    DMANow(3, undergroundPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, undergroundTiles, &((charblock *)0x6000000)[0], 512 / 2);
    DMANow(3, undergroundMap, &((screenblock *)0x6000000)[31], 2048 / 2);
    state = GAME;
}
