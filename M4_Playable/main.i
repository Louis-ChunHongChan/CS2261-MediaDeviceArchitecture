...
void goToGame() {
    ...
    (*(volatile unsigned short *)0x4000000) = 3 | (1 << 8) | (1 << 12);
    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((28) << 8) | (2 << 14);
    DMANow(3, undergroundPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, undergroundTiles, &((charblock *)0x6000000)[1], 42048 / 2);
    DMANow(3, undergroundMap, &((screenblock *)0x6000000)[28], 6144 / 2);


    (*(volatile unsigned short *)0x4000000) = 4 | (1 << 10) | (1 << 12);

    DMANow(3, levelPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, levelTiles, &((charblock *)0x6000000)[1], 16608 / 2);
