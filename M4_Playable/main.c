/* Comment Block
The game has win/lose condition, the core gameplay mechanics (walk, jump, ladder climbing, power-ups pick up, cheat), time limit and visual indicator for time remaining, restart in pause menu, all the levels of the final version, timer, modify background tiles at runtime, sounds, art, and different enemies and corresponding animations are finished.
TODO/FIXME: The XL background is a bit buggy (I really did my best and tried everything, gonna need some help).
...
void goToGame() {
    ...
    // REG_DISPCTL = MODE3 | BG0_ENABLE | BG2_ENABLE | SPRITE_ENABLE;
    // REG_BG2CNT = BG_CHARBLOCK(1) | BG_SCREENBLOCK(28) | BG_SIZE_TALL;
