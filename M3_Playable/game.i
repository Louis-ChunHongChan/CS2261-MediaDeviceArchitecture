...
void displayTime() {
    ...
    shadowOAM[20].attr0 = (guy.row - 16 - vOff) | (0 << 14);
    shadowOAM[20].attr1 = (guy.col - 4 - hOff) | (0 << 14);
    shadowOAM[20].attr2 = ((time_m_10s + 2)*32 + (0)) | ((0) << 12);

    shadowOAM[21].attr0 = (guy.row - 16 - vOff) | (0 << 14);
    shadowOAM[21].attr1 = (guy.col - hOff) | (0 << 14);
    shadowOAM[21].attr2 = ((time_m_1s + 2)*32 + (0)) | ((0) << 12);

    shadowOAM[22].attr0 = (guy.row - 16 - vOff) | (0 << 14);
    shadowOAM[22].attr1 = (guy.col + 4 - hOff) | (0 << 14);
    shadowOAM[22].attr2 = ((12)*32 + (0)) | ((0) << 12);

    shadowOAM[23].attr0 = (guy.row - 16 - vOff) | (0 << 14);
    shadowOAM[23].attr1 = (guy.col + 8 - hOff) | (0 << 14);
    shadowOAM[23].attr2 = ((time_s_10s + 2)*32 + (0)) | ((0) << 12);

    shadowOAM[24].attr0 = (guy.row - 16 - vOff) | (0 << 14);
    shadowOAM[24].attr1 = (guy.col + 12 - hOff) | (0 << 14);
...
void initShirt() {
    shirt.width = 16;
    shirt.height = 16;
    shirt.col = 240 / 2 - shirt.width * 6 - 8;
    shirt.row = 26+256;
    shirt.active = 1;
}
...
void initBubble() {
    bubble.width = 16;
    bubble.height = 16;
    bubble.col = 240 / 2 - bubble.width * 4;
    bubble.row = 60+256;
    bubble.active = 1;
}
# 271 "game.c"
...
void updateGame() {
    frame++;
# 365 "game.c"
    if (vOff+1 < 512 - 160 && (guy.row - vOff) > (160 / 2)) {
        vOff++;
    }
    if (vOff-1 >= 0 && (guy.row - vOff) <= (160 / 2)) {
    ...
    if (!climbing && !jumping && !down) {
        if((~((*(volatile unsigned short *)0x04000130)) & ((1 << 5)))) {
            if (collisionCheck(collisionMap, 256, guy.col, guy.row, guy.width, guy.height, -guy.cdel, 0) && guy.col > 0) {
                ...
                if (hOff-1 >= 0 && (guy.col - hOff) <= (240 / 2)) {
                    hOff--;
                }
            }
        }
        ...
        if((~((*(volatile unsigned short *)0x04000130)) & ((1 << 4)))) {
            if (collisionCheck(collisionMap, 256, guy.col, guy.row, guy.width, guy.height, guy.cdel, 0)
                ...
                if (hOff+1 < 256 - 240 && (guy.col - hOff) > (240 / 2)) {
                    hOff++;
                }
            }
        }
...
# 646 "game.c"
    for (int i = 0; i < 6; i++) {
        ...
        if (i == 0) {
            ...
            if (crazy[i].col <= 240 / 2 - crazy[i].width * 4 - 8) {
                crazy[i].cdel = 1;
            }
            crazy[i].col += crazy[i].cdel;
        }
        if (i == 2) {
            if (crazy[i].col >= 240 / 2 - crazy[i].width * 2 - 6) {
                crazy[i].cdel = -1;
            }
            if (crazy[i].col <= 240 / 2 - crazy[i].width * 6) {
                crazy[i].cdel = 1;
            }
            crazy[i].col += crazy[i].cdel;
        }
        if (i == 3) {
            if (crazy[i].col >= 240 / 2 - crazy[i].width * 4 + 6) {
                crazy[i].cdel = -1;
            }
            if (crazy[i].col <= 240 / 2 - crazy[i].width * 7 + 7) {
                crazy[i].cdel = 1;
            }
            crazy[i].col += crazy[i].cdel;
        }
...
void animateGuy() {
    ...
    if (!climbing && !down && !jumping) {
            if((~((*(volatile unsigned short *)0x04000130)) & ((1 << 5))) && !powerUp) {
                guy.aniState = LEFT;
            }
            if((~((*(volatile unsigned short *)0x04000130)) & ((1 << 4))) && !powerUp) {
                guy.aniState = RIGHT;
            }
            if (!powerUp && !down && !jumping && !floating) {
...
void drawGuy() {
    shadowOAM[0].attr0 = ((guy.row - vOff) & 0xFF) | (0 << 14);
    shadowOAM[0].attr1 = ((guy.col - hOff) & 0x1FF) | (1 << 14);
    shadowOAM[0].attr2 = ((0)*32 + (10)) | ((0) << 12);
# 891 "game.c"
}

void drawDoor() {
    if (door.active && door.row - vOff > 0 && door.col - hOff > 0 && door.col - hOff < 240 && door.row - vOff < 160) {
        shadowOAM[15].attr0 = ((door.row - vOff) & 0xFF) | (2 << 14);
        shadowOAM[15].attr1 = ((door.col - hOff) & 0x1FF) | (2 << 14);
...
void drawKey() {
    if (key.active && key.row - vOff > 0 && key.col - hOff > 0 && key.col - hOff < 240 && key.row - vOff < 160) {
        shadowOAM[16].attr0 = ((key.row - vOff) & 0xFF) | (0 << 14);
        shadowOAM[16].attr1 = ((key.col - hOff) & 0x1FF) | (1 << 14);
        shadowOAM[16].attr2 = ((0)*32 + (6)) | ((0) << 12);
    }
    else {
...
void drawShirt() {
    if (shirt.active && shirt.row - vOff > 0 && shirt.col - hOff > 0 && shirt.col - hOff < 240 && shirt.row - vOff < 160) {
        shadowOAM[18].attr0 = ((shirt.row - vOff) & 0xFF) | (0 << 14);
        shadowOAM[18].attr1 = ((shirt.col - hOff) & 0x1FF) | (1 << 14);
        shadowOAM[18].attr2 = ((0)*32 + (2)) | ((0) << 12);
    }
    else {
...
void drawBubble() {
    if (bubble.active && bubble.row - vOff > 0 && bubble.col - hOff > 0 && bubble.col - hOff < 240 && bubble.row - vOff < 160) {
        shadowOAM[19].attr0 = ((bubble.row - vOff) & 0xFF) | (0 << 14);
        shadowOAM[19].attr1 = ((bubble.col - hOff) & 0x1FF) | (1 << 14);
        shadowOAM[19].attr2 = ((0)*32 + (15)) | ((0) << 12);
    }
    else {
...
void drawCustomer() {
    if (customer.row - vOff > 0 && customer.col - hOff > 0 && customer.col - hOff < 240 && customer.row - vOff < 160) {
        ...
        shadowOAM[2].attr2 = ((0)*32 + (13)) | ((0) << 12);
    }
    else {
...
void drawCrazy() {
    for (int i = 0; i < 6; i++) {
        shadowOAM[30+i].attr0 = ((crazy[i].row - vOff) & 0xFF) | (0 << 14);
        shadowOAM[30+i].attr1 = ((crazy[i].col - hOff) & 0x1FF) | (1 << 14);
        if (crazy[i].row - vOff > 0 && crazy[i].col - hOff > 0 && crazy[i].col - hOff < 240 && crazy[i].row - vOff < 160) {

            shadowOAM[30+i].attr2 = ((0)*32 + (17)) | ((0) << 12);
        }
        else {
...
void drawHeart() {
    ...
    for (int i = 0; i < 3; i++) {
        if (heart[i].active) {
            shadowOAM[9+i].attr0 = (guy.row - 8 - vOff) | (0 << 14);

            shadowOAM[9+i].attr1 = (guy.col - 8 + shift - hOff) | (0 << 14);
            shadowOAM[9+i].attr2 = ((0)*32 + (12)) | ((0) << 12);
        }
        else {
            shadowOAM[9+i].attr0 = (guy.row - 8 - vOff) | (0 << 14);
            shadowOAM[9+i].attr1 = (guy.col - 8 + shift - hOff) | (0 << 14);
            shadowOAM[9+i].attr2 = ((0)*32 + (30)) | ((0) << 12);
        }
        shift += 8;
    }
}
