...
void initCustomer() {
    ...
    customer.row = 25+256;
    customer.col = 240 / 2 + customer.width * 5;
...
void initBubble() {
    bubble.width = 16;
    bubble.height = 16;
    bubble.col = 240 / 2 - bubble.width * 6;
    bubble.row = 60+256;
    bubble.active = 1;
}
# 272 "game.c"
...
void drawGuy() {
    if (guy.row - vOff <= 0 || guy.col - hOff <= 0) {
        shadowOAM[0].attr2 = ((0)*32 + (30)) | ((0) << 12);
    }
    shadowOAM[0].attr0 = (guy.row - vOff) | (0 << 14);
    shadowOAM[0].attr1 = (guy.col - hOff) | (1 << 14);
...
void drawDoor() {
    if (door.row - vOff <= 0 || door.col - hOff <= 0) {
        shadowOAM[15].attr2 = ((0)*32 + (30)) | ((0) << 12);
    }
    if (door.active) {
        shadowOAM[15].attr0 = (door.row - vOff) | (2 << 14);
        shadowOAM[15].attr1 = (door.col - hOff) | (2 << 14);
        shadowOAM[15].attr2 = ((0)*32 + (8)) | ((0) << 12);
    }
    else {
        shadowOAM[15].attr0 = (door.row - vOff) | (2 << 14);
        shadowOAM[15].attr1 = (door.col - hOff) | (2 << 14);
        shadowOAM[15].attr2 = ((0)*32 + (26)) | ((0) << 12);
    }
}

void drawKey() {
    if (key.row - vOff <= 0 || key.col - hOff <= 0) {
        shadowOAM[16].attr2 = ((0)*32 + (30)) | ((0) << 12);
    }
    if (key.active) {
        shadowOAM[16].attr0 = (key.row - vOff) | (0 << 14);
        shadowOAM[16].attr1 = (key.col - hOff) | (1 << 14);
        shadowOAM[16].attr2 = ((0)*32 + (6)) | ((0) << 12);
    }
    else {
        shadowOAM[16].attr0 = (key.row - vOff) | (0 << 14);
        shadowOAM[16].attr1 = (key.col - hOff) | (1 << 14);
        shadowOAM[16].attr2 = ((0)*32 + (26)) | ((0) << 12);
    }
}

void drawBoots() {
    if (boots.row - vOff <= 0 || boots.col - hOff <= 0) {
        shadowOAM[17].attr2 = ((0)*32 + (30)) | ((0) << 12);
    }
    if (boots.active) {
        shadowOAM[17].attr0 = (boots.row - vOff) | (0 << 14);
        shadowOAM[17].attr1 = (boots.col - hOff) | (1 << 14);
        shadowOAM[17].attr2 = ((0)*32 + (4)) | ((0) << 12);
    }
    else {
        shadowOAM[17].attr0 = (boots.row - vOff) | (0 << 14);
        shadowOAM[17].attr1 = (boots.col - hOff) | (1 << 14);
        shadowOAM[17].attr2 = ((0)*32 + (26)) | ((0) << 12);
    }
}

void drawShirt() {
    if (shirt.active) {
        shadowOAM[18].attr0 = (shirt.row - vOff) | (0 << 14);
        shadowOAM[18].attr1 = (shirt.col - hOff) | (1 << 14);
        if (shirt.row - vOff <= 0 || shirt.col - hOff <= 0) {
            shadowOAM[18].attr2 = ((30)*32 + (30)) | ((0) << 12);
        }
        else {
        ...
        shadowOAM[18].attr0 = (shirt.row - vOff) | (0 << 14);
        shadowOAM[18].attr1 = (shirt.col - hOff) | (1 << 14);
        shadowOAM[18].attr2 = ((0)*32 + (30)) | ((0) << 12);
    }
}

void drawBubble() {
    if (bubble.active) {
        shadowOAM[19].attr0 = (bubble.row - vOff) | (0 << 14);
        shadowOAM[19].attr1 = (bubble.col - hOff) | (1 << 14);
        if (bubble.row - vOff <= 0 || bubble.col - hOff <= 0) {
            shadowOAM[19].attr2 = ((0)*32 + (30)) | ((0) << 12);
        }
        else {
...
void drawCustomer() {
    if (customer.row - vOff <= 0 || customer.col - hOff <= 0) {
        shadowOAM[2].attr2 = ((0)*32 + (30)) | ((0) << 12);
    }
...
void drawCrazy() {
    for (int i = 0; i < 6; i++) {
        if (crazy[i].row - vOff <= 0 || crazy[i].col - hOff <= 0) {
            shadowOAM[30+i].attr2 = ((0)*32 + (30)) | ((0) << 12);
        }
        shadowOAM[30+i].attr0 = (crazy[i].row - vOff) | (0 << 14);
        shadowOAM[30+i].attr1 = (crazy[i].col - hOff) | (1 << 14);
