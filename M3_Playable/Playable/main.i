...
void goToStart() {
    ...
    DMANow(3, titleTiles, &((charblock *)0x6000000)[0], 4416 / 2);
...
void goToInstruction() {
    ...
    DMANow(3, instructionTiles, &((charblock *)0x6000000)[0], 8192 / 2);
...
void goToGame() {
    ...
    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((28) << 8) | (2 << 14);
    DMANow(3, undergroundPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, undergroundTiles, &((charblock *)0x6000000)[1], 608 / 2);
    DMANow(3, undergroundMap, &((screenblock *)0x6000000)[28], 4096 / 2);
