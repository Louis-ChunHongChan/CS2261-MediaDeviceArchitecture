...
void updateGame() {
    ...
    // collisionCheck(laddercollisionMap, MAPWIDTH, mario.col, mario.row, mario.width, mario.height, 0, mario.rdel) ||
...
void updateMario() {
    // Pauline collision
    if (collision(mario.col, mario.row, mario.width, mario.height, pauline.col, pauline.row, pauline.width, pauline.height)) {
        // TODO: Go to next Level && + 2 score
        score++;
        nextLevel = 1;
    }
