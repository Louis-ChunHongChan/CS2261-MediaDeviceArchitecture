...
# 1 "level2.h" 1
# 22 "level2.h"
extern const unsigned short level2Tiles[3216];
...
void initialize() {
    ...
    DMANow(3, titleTiles, &((charblock *)0x6000000)[0], 8608 / 2);
...
void initialize2() {
    ...
    DMANow(3, level2Tiles, &((charblock *)0x6000000)[0], 6432 / 2);
...
void goToGame() {
    ...
    if (!nextLevel) {
        ...
        DMANow(3, gameBgTiles, &((charblock *)0x6000000)[0], 672 / 2);
        DMANow(3, gameBgMap, &((screenblock *)0x6000000)[31], 2048 / 2);
    }
    else {
        DMANow(3, gameBg2Pal, ((unsigned short *)0x5000000), 256);
        DMANow(3, gameBg2Tiles, &((charblock *)0x6000000)[0], 672 / 2);
        DMANow(3, gameBg2Map, &((screenblock *)0x6000000)[31], 2048 / 2);
    }
    state = GAME;
}
...
void goToWin() {
    ...
    DMANow(3, winTiles, &((charblock *)0x6000000)[0], 9728 / 2);
